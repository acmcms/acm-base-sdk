 ...
 * 		
 */
public class FormEntryDeleteConfirmationMultiple extends AbstractForm<FormEntryDeleteConfirmationMultiple> {
	 ...
	 * @param keys
	 */
	public FormEntryDeleteConfirmationMultiple(final StorageImpl parent, final String sectionId, final BaseArray keys) {
		this.parent = parent;
	...
	public Object getCommandResult(final ControlCommand<?> command, final BaseObject arguments) {
		...
		if (command == FormEntryDeleteConfirmationMultiple.COMMAND_DELETE) {
	...
	public ControlCommandset getCommands() {
		...
		result.add(FormEntryDeleteConfirmationMultiple.COMMAND_DELETE);
		return result;
	}
	...
	public ControlFieldset<?> getFieldset() {
		...
		return FormEntryDeleteConfirmationMultiple.FIELDSET_DELETE;
	}
}
