...
final class FilterConnection implements Connection {
	...
	protected void finalize() throws java.lang.Throwable {
		if (this.parent != null) {
			try {
				...
				this.parent = null;
				this.logger.event( this.owner,
						"CLOSE-FIN",
						"lifetime=" + this.logger.formatPeriod( System.currentTimeMillis() - this.birthDate ) );
			}
		}
		super.finalize();
	}
	...
	public CallableStatement prepareCall(
		...
		return this.convert( sql,
				this.parent.prepareCall( sql, resultSetType, resultSetConcurrency, resultSetHoldability ) );
	}
	...
	public PreparedStatement prepareStatement(
			...
			final int resultSetType,
			final int resultSetConcurrency,
			final int resultHoldability) throws SQLException {
		if (this.parent == null) {
			throw new SQLException( "Connection is closed (" + this + ")!" );
		}
		return this.convert( sql,
				this.parent.prepareStatement( sql, resultSetType, resultSetConcurrency, resultHoldability ) );
	}
