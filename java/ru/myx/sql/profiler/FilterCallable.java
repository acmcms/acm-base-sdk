...
final class FilterCallable extends FilterPrepared implements CallableStatement {
	FilterCallable(final String owner,
			final FilterConnection connection,
			final CallableStatement parent,
			final String sql) {
	...
	@Override
	public void setDate(final int index, final java.sql.Date date, final java.util.Calendar cal)
			throws java.sql.SQLException {
	...
	@Override
	public void setDate(final String name, final java.sql.Date date, final java.util.Calendar cal)
			throws java.sql.SQLException {
	...
	@Override
	public void setTime(final int index, final java.sql.Time time, final java.util.Calendar cal)
			throws java.sql.SQLException {
	...
	@Override
	public void setTime(final String name, final java.sql.Time time, final java.util.Calendar cal)
			throws java.sql.SQLException {
		this.c().setTime( name, time, cal );
	}
	
	@Override
	public void setTimestamp(final int index, final java.sql.Timestamp timestamp, final java.util.Calendar cal)
			throws java.sql.SQLException {
	...
	@Override
	public void setTimestamp(final String name, final java.sql.Timestamp timestamp, final java.util.Calendar cal)
			throws java.sql.SQLException {
