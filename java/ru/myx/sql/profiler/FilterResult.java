...
final class FilterResult implements ResultSet {
	...
	@Override
	public void updateAsciiStream(final String columnName, final InputStream input, final int length) throws SQLException {
	...
	@Override
	public void updateBinaryStream(final int columnIndex, final InputStream input, final int length) throws SQLException {
	...
	@Override
	public void updateBinaryStream(final String columnName, final InputStream input, final int length) throws SQLException {
