 ...
 */
final class AcmNullPluginFactory implements AcmPluginFactory {
	
	private static final String[] VARIETY = {
			"ACMMOD:ACM.NOTHING", "ACMMOD:ACM.NOTHING", "ACMMOD:ACM.NULL", "ACMMOD:ACM.NULL"
	};
	...
	public final String[] variety() {
		...
		return AcmNullPluginFactory.VARIETY;
	}
}
